...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        catch (NullPointerException | IllegalArgumentException nul)
        {
            LOGGER.info(EXCEPTION_MARKER, "Exception: ", nul);
        }
            ...
            for (; ; ) {
                ...
                LOGGER.info(INPUT_HISTORY_MARKER, "Ищут станции: {}", from);
                Station to = takeStation("Введите станцию назначения:");
                LOGGER.info(INPUT_HISTORY_MARKER, "Ищут станции: {}", to);
    ...
    private static void createStationIndex()
    {
        ...
        try
        {
            ...
            LOGGER.info(EXCEPTION_MARKER, "Exception: ", ex);
        }
    }
